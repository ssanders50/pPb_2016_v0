...
if ivars.ntrkMin == 120:
    ...
    process.p = cms.Path(process.hltHM120*process.eventSelection*process.Noff*process.ppNoffFilter120*process.QWEvent * process.QWV0EventKs  * process.mon120*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 150:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.hltHM150*process.eventSelection*process.Noff*process.ppNoffFilter150*process.QWEvent * process.QWV0EventKs * process.mon150*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 185:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.hltHM185*process.eventSelection*process.Noff*process.ppNoffFilter185*process.QWEvent * process.QWV0EventKs * process.mon185*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
...
if ivars.ntrkMin == 250:
    ...
    process.es_prefer_flatparms = cms.ESPrefer('PoolDBESSource','')
    process.p = cms.Path(process.hltHM250*process.eventSelection*process.Noff*process.ppNoffFilter250*process.QWEvent * process.QWV0EventKs *  process.mon250*process.hiEvtPlane*process.hiEvtPlaneFlat*process.vnanalyzer)
