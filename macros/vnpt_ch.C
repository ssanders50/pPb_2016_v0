...
void vnpt_ch(){
  ...
  Colors[0] = kRed;
  Colors[1] = kBlue;
  //vnptCalc("filelists/pPb_MB_ch.dat", 0, 10, Markers, Colors);
  //vnptCalc("filelists/pPb_MB_ch.dat", 10, 30, Markers, Colors);
  //vnptCalc("filelists/pPb_MB_ch.dat", 30, 50, Markers, Colors);
  //vnptCalc("filelists/pPb_MB_ch.dat", 50, 70, Markers, Colors);
  //vnptCalc("filelists/pPb_MB_ch.dat", 70, 90, Markers, Colors);
  //vnptCalc("filelists/pPb_MB_ch.dat", 90, 120, Markers, Colors);
  //vnptCalc("filelists/pPb_HM120_ch.dat", 120, 150, Markers, Colors);
  vnptCalc("filelists/pPb_HM150_ch.dat", 150, 185, Markers, Colors);
  vnptCalc("filelists/pPb_HM185_ch.dat", 185, 250, Markers, Colors);
  //vnptCalc("filelists/pPb_HM250_ch.dat", 250, 500, Markers, Colors);
  Markers[0] = 25;
  Markers[1] = 24;
  Colors[0] = kBlue;
  Colors[1] = kRed;
  //vnptCalc("filelists/Pbp_MB_ch.dat", 0, 10, Markers, Colors);
  //vnptCalc("filelists/Pbp_MB_ch.dat", 10, 30, Markers, Colors);
  //vnptCalc("filelists/Pbp_MB_ch.dat", 30, 50, Markers, Colors);
  //vnptCalc("filelists/Pbp_MB_ch.dat", 50, 70, Markers, Colors);
  //vnptCalc("filelists/Pbp_MB_ch.dat", 70, 90, Markers, Colors);
  //vnptCalc("filelists/Pbp_MB_ch.dat", 90, 120, Markers, Colors);
  //vnptCalc("filelists/Pbp_HM120_ch.dat", 120, 150, Markers, Colors);
  vnptCalc("filelists/Pbp_HM150_ch.dat", 150, 185, Markers, Colors);
  vnptCalc("filelists/Pbp_HM185_ch.dat", 185, 250, Markers, Colors);
  //vnptCalc("filelists/Pbp_HM250_ch.dat", 250, 500, Markers, Colors);
}
